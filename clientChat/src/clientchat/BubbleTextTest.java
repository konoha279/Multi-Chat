...
public class BubbleTextTest {
    ...
    public class TestPane extends JPanel {
        ...
        public TestPane() {
            ...
            gbc.gridx = 0;
            gbc.gridy = 0;
                add(new JLabel(new ImageIcon("D:\\TopLeft.png", "Lock")), gbc);
                gbc.gridx = 2;
                add(new JLabel(new ImageIcon("D:\\TopRight.png", "Lock")), gbc);

                gbc.gridy = 2;
                gbc.gridx = 0;
                add(new JLabel(new ImageIcon("D:\\BottomLeft.png", "Lock")), gbc);
                gbc.gridx = 2;
                add(new JLabel(new ImageIcon("D:\\BottomRight.png", "Lock")), gbc);

                gbc.gridx = 1;
                gbc.gridy = 0;
                gbc.weightx = 1;
                gbc.fill = GridBagConstraints.HORIZONTAL;
               add(new JLabel(new ImageIcon("D:\\Top.png", "Lock")), gbc);
                gbc.gridy = 2;
                 add(new JLabel(new ImageIcon("D:\\Bottom.png", "Lock")), gbc);
               ...
               add(new JLabel(new ImageIcon("D:\\Left.png", "Lock")), gbc);
                 add(new JLabel(new ImageIcon("D:\\Right.png", "Lock")), gbc);
